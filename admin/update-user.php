    ...
    <div class="uk-child-width-expand@s uk-grid-match " uk-grid>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-hover uk-card-body">
                ...
                if( user_input_check( 'updateuser' ) ) {
                    ...
                    <form class="uk-form-horizontal" method="post" enctype="multipart/form-data">
                        <fieldset class="uk-fieldset">
                            ...
                            <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                                ...
                                <label><input class="uk-radio" value="M" type="radio"
                                              name="gender" <?= $user[ 'gender' ] == 1 ? "checked" : "" ?> > مرد</label>
                                <label><input class="uk-radio" value="F" type="radio"
                                              name="gender" <?= $user[ 'gender' ] == 0 ? "checked" : "" ?> > زن</label>
                            </div>
                            <!-- USERNAME -->
                            <div class="uk-margin">
                            ...
                            <div class="uk-margin">
                                ...
                                <input class="uk-input uk-form-width-medium" id="password" name="password"
                                       type="password" placeholder="" value="" autocomplete="new-password">
                            </div>
                            <!-- RE-PASSWORD -->
                            <div class="uk-margin">
                                <label class="uk-form-label" for="re-password"> پسورد مجدد: </label>
                                <input class="uk-input uk-form-width-medium" id="re-password" name="repassword"
                                       type="password" placeholder="" value="" autocomplete="new-password">
                            </div>
                            <!-- EMAIL -->
                            <div class="uk-margin">
                            ...
                            <div class="uk-margin">
                                <input type="submit" class="uk-button uk-button-primary" name="updateuser"
                                       value="بروز رسانی کاربر">
                            </div>
